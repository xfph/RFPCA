...
out.U=eigvector; if center out.m=sampleMean; end
out.lmd=eigvalue/nSmp; out.elapse=elapse;
if ReducedDim < nFea
    out.s2=(s2-sum(eigvalue))/(nFea-ReducedDim)/nSmp;
else out.s2=0;
end
%[eigvector, eigvalue, elapse]
